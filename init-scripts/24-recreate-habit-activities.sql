-- Migration: Recreate habit activities table from scratch
-- This script drops and recreates the table to avoid migration issues

USE phc_dashboard;

-- Drop existing tables if they exist
DROP TABLE IF EXISTS user_habit_activities;
DROP TABLE IF EXISTS available_habit_activities;
