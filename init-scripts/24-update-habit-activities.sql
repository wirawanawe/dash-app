-- Migration: Update existing habit activities table and add data
-- This script updates the existing table structure and adds habit activities

USE phc_dashboard;

-- Update the existing available_habit_activities table structure
