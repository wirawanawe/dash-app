 ...
 * @param {number} maxAge - Maximum age in seconds (default: 86400 = 24 hours)
...
/**
 * Extracts and verifies a mobile user's auth from a Next.js Request
 * Looks for Bearer token in Authorization header, then falls back to 'token' cookie
